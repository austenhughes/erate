...
function Why() {
  return (
    ...
    {/* <div className="main">
    <div className="center"> CAS Reduces Application Burden By : </div>
    <ul> 
      <li>Filing all E - Rate forms including 470, 471, 486, 500, BEAR, and others as deemed necessary</li>
      <li>Answering all PIA questions</li>
      <li>Managing audits and reviews</li>
      <li>Filing RALs and appeals</li>
      <li>Designating reimbursement methods with vendors</li>
      <li>Creating RFPs</li>
    </ul>
    </div> */}

    {/* <div className="main">
        <div className="center">CAS Maximizes Discount Rate : </div>
        <ul>
    ...
    {/* <div className="main">
        <div className="center">CAS Ensures All Eligible Services are Included : </div>
        <ul>
    ...
    {/* <div className="main">
        <div className="center">CAS Ensures Legal Compliance : </div>
        <ul>
    ...
    {/* <div className="main">
        <div className="center">CAS Manages Audits : </div>
        <ul>
  ...
  <Accordion.Item  eventKey="0">
    <Accordion.Header><div className="bigger">CAS Reduces Application Burden :</div></Accordion.Header>
    <Accordion.Body>
    <ul> 
  ...
  <Accordion.Item eventKey="1">
    <Accordion.Header> <div className="bigger">CAS Maximizes Discount Rate :</div></Accordion.Header>
    <Accordion.Body>
    <ul>
            <li> Review Free and Reduced eligibility numbers with Child Nutrition Staff</li>
            <li> Experts in alternative methods of discount calculation including;
  ...
  <Accordion.Item eventKey="2">
    <Accordion.Header> <div className="bigger"> CAS Ensures All Eligible Services are Included :</div> </Accordion.Header>
    <Accordion.Body>
    <ul>
            <li>Regularly discuss needs with technology staff</li>
            <li>Attend trainings & conference calls to be up to date on eligibility services list</li>
  ...
  <Accordion.Item eventKey="3">
    <Accordion.Header> <div className="bigger"> CAS Ensures Legal Compliance : </div></Accordion.Header>
    <Accordion.Body>
    <ul>
            <li>All consultants attend yearly USAC training</li>
            <li>Consultants regularly participate in conference calls and webinars with USAC, vendors, and state officials</li>
  ...
  <Accordion.Item eventKey="4">
    <Accordion.Header><div className="bigger"> CAS Manages Audits :</div></Accordion.Header>
    <Accordion.Body>
    <ul>
            <li>CAS will be physically present for any on-site audit</li>
            <li>As part of engagement will manage audits of all past applications</li>
